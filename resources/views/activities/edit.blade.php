...
<div class="container">
    <div class="row justify-content-center text-dark">
        <div class="col-md-8  ">
            <div class="card">
                <div class="card-header">{{ __('Update Activity Event') }}</div>
                <div class="card-body">
                    ...
                    <form action="{{ route('activities.update', ['activity' => $activity]) }}" method="post">
                        ...
                        <div class="form-group ">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                   name="name" value="{{ $activity->name }}" required autocomplete="name" autofocus>
                        ...
                        Start time:
                        <br/>
                        <input type="text" name="activity_date" class="datetimepicker" value="{{ $activity->activity_date }}"/>
                        <br/><br/>
